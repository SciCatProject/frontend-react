      ...
      setAutocompleteData((prevData) => {
        const newData = [
          ...
          },
          {
            ...
            label: 'Location',
            selectedOptions:
              prevData.find((item) => item.label === 'Location')?.selectedOptions || [],
          ...
          },
          {
            ...
            label: 'Keywords',
            selectedOptions:
              prevData.find((item) => item.label === 'Keywords')?.selectedOptions || [],
  ...
  useEffect(() => {
    ...
    if (startDate && endDate) {
      selectedFilters.push(
        `"creationTime": {"begin": "${startDate.toISOString().split('T')[0]}", "end": "${
